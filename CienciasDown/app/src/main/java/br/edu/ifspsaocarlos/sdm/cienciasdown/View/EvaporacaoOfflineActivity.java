...
public class EvaporacaoOfflineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaporacao_offline);
        ...
        videoview = (VideoView) findViewById(R.id.videoViewEvaporacao);
        iniciaVideo();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        EvaporacaoOfflineActivity v = this;
    ...
    private void iniciaVideo(){
        ...
        pDialog = new ProgressDialog(EvaporacaoOfflineActivity.this);
        ...
        try {
            ...
            MediaController mediacontroller = new MediaController(
                    EvaporacaoOfflineActivity.this);
    ...
    public void onClickEvap(View v){
        if(tentar){
            try{
                ...
                Toast.makeText(EvaporacaoOfflineActivity.this, "Ocorreu uma falha, por favor tente novamente.",
    ...
    private void playAudio(){
        mp = MediaPlayer.create(EvaporacaoOfflineActivity.this, R.raw.aplauso);
        mp.start();
    }
